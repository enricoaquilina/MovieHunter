                                ...
                                if is_title_foreign_free(title_parts):
                                    if is_title_in_english(break_movie_title(film_title)):
                                        if is_high_quality(title_parts):
                                            if does_file_exist(PROJECT_NAME, film_year):
                                                if does_film_exist(PROJECT_NAME, film_title, film_year):
                                                    append_to_file(PROJECT_NAME + '/Year_'+film_year+'.txt', film_title)
